...
<!--------首页 banenr ------->
<div id="myCarousel" class="carousel slide" style="margin: 0 auto; max-width: 640px;">
    <!-- 轮播（Carousel）指标 -->
    <ol class="carousel-indicators"  style="bottom:0.05rem">
    ...
    <div class="carousel-inner">
        <div class="item active">
            <img src="/etwap/etwap/erwap/Public/image/sy_b1.jpg" alt="First slide">
        </div>
        <div class="item">
            <img src="/etwap/etwap/erwap/Public/image/sy_b2.jpg" alt="Second slide">
        </div>
        <div class="item">
            <img src="/etwap/etwap/erwap/Public/image/sy_b1.jpg" alt="Third slide">
        </div>
    </div>
...
<div class="container">
    <ul class="row bc_tb">
        <li class="col-xs-4">
            <p class="bc_tit1"><img src="/etwap/etwap/erwap/Public/image/bc1.jpg">预约挂号</p>
            <p class="bc_ms1">轻松预约  只需三步</p>
        </li>

        <li class="col-xs-4">
            <p class="bc_tit1"><img src="/etwap/etwap/erwap/Public/image/bc2.jpg">医生团队</p>
            <p class="bc_ms1">直接对话  专业医生</p>
        </li>

        <li class="col-xs-4">
            <p class="bc_tit1"><img src="/etwap/etwap/erwap/Public/image/bc3.jpg">常见问题</p>
            <p class="bc_ms1">遇到问题  联系客服</p>
        </li>
...
<div class="container">
    <ul class="row gong1">
        <li class="col-xs-3 gg_z1">公告<img src="/etwap/etwap/erwap/Public/image/gg1.jpg"></li>
        <li class="col-xs-9" style="margin-left: -1rem; ">
            <div class="txtScroll-top">

                <div class="bd">
                    <ul class="infoList">
                        <li><a href="">公司公告公告公告公告公告</a></li>
                        <li><a href="">文字222222222222222</a></li>
                    </ul>
                </div>
            </div>
...
<div class="container">
    ...
    <ul class="row tjzj_li1">
        <li class="col-xs-4">
            <p class="tjzj_tx1"><a href=""><img src="/etwap/etwap/erwap/Public/image/tjzj01.png"></a></p>
            <h3 class="tjzj_name1"><a href="">李明</a></h3>
            <p class="tjzj_zc1">主任医师</p>
            <p class="tjzj_gh_btn1"><a href="">预约挂号</a></p>
        </li>
...
<div class="container">
    <ul class="row">
        <li class="col-xs-12" style="padding: 0; margin-top: 0.8rem;"><a href=""><img src="/etwap/etwap/erwap/Public/image/sy_bn.jpg"></a></li>
    </ul>
</div>
<!--------首页下面小banner  end ------>
...
<div class="container">
    <ul class="row">
        <li class="col-xs-9"><p class="keshi_k1">最新资讯</p></li>
        <li class="col-xs-3"><a href="" class="tjzj_more1">更多</a></li>
    </ul>


    <ul class="row zx_list1">
        <li>
            <div class="col-xs-4 zx_lt1"><a href=""><img src="/etwap/etwap/erwap/Public/image/zx01.jpg"></a></div>
            <div class="col-xs-8 zx_mg2">
